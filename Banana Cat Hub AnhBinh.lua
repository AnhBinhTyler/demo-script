...
local function ShootLoop()
    while isShooting do
        ...
        task.wait() -- Tốc độ bắn NHANH HƠN: 0.03s thay vì 0.05s
    end
end

Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/AnhBinhTyler/UI/refs/heads/main/UI-BANANA-CAT.lua"))()
...
local BananaCatLoaded = false

AdminBox:AddButton({
    Title = "Anh Binh Dev(OFF)",
    Callback = function()
        if not BananaCatLoaded then
            BananaCatLoaded = true

            task.spawn(function() -- fix không chạy
                loadstring(game:HttpGet("https://raw.githubusercontent.com/WhiteX1208/Scripts/refs/heads/main/AdminBananaCat.luau"))()
            end)
